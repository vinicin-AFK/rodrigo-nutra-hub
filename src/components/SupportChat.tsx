          ...
          {isRecording ? (
            ...
            <>
              ...
              <input
                ...
                className="flex-1 min-w-0 bg-gray-100 dark:bg-secondary rounded-xl px-4 py-2.5 text-sm text-gray-900 dark:text-gray-100 placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/50"
              />
